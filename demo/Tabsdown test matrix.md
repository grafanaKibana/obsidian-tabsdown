...
| Configure one authored block from its ellipsis menu across wide, split-pane (around 28rem), and phone widths. Try Inherit, Default, and Compact density plus every personality. | Inherit becomes Compact only at 28rem or narrower; explicit Default/Compact stays fixed; nested blocks resolve independently; touch tabs and the ellipsis action remain at least 44 × 44 px. |
